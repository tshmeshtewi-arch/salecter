...
// Only apply the Firebase plugin if google-services.json actually exists.
// This lets the project build (e.g. on GitHub Actions) even before you've
// added your own Firebase config file. Login/Firebase features simply won't
// work at runtime until you add the real file — see README for instructions.
